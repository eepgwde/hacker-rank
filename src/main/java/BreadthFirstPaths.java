...
/**
 * The {@code BreadthFirstPaths} class represents a data type for finding shortest paths (number of edges) from a source
 * vertex <em>s</em> (or a set of source vertices) to every other vertex in an undirected graph.
 * This implementation uses breadth-first search. The constructor takes time proportional to <em>V</em> + <em>E</em>,
